...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        self.browser.find_element_by_id('id_new_report').send_keys('\n')
        ...
        self.browser.find_element_by_id('id_new_report').send_keys('Shadiness occurred\n')
        ...
        self.browser.find_element_by_id('id_new_report').send_keys('It happened again\n')
        self.check_for_row_in_report_table('Report 1: Shadiness occurred')
